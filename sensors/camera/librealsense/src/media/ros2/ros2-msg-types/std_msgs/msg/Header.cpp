...
{
    // m_stamp com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@1888ff2c

    // m_frame_id com.eprosima.idl.parser.typecode.StringTypeCode@5e8c92f4
    m_frame_id ="";

    // Removed DDS-specific: registerHeaderTypes();
}
