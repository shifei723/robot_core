...
{
    // m_x com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4617c264
    m_x = 0.0;
    // m_y com.eprosima.idl.parser.typecode.PrimitiveTypeCode@36baf30c
    m_y = 0.0;
    // m_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7a81197d
    m_z = 0.0;
    // m_w com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5ca881b5
    m_w = 1.0;

    // Removed DDS-specific: registerQuaternionTypes();
}
