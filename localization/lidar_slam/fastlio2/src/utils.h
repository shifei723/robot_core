...
public:
    ...
    static pcl::PointCloud<pcl::PointXYZINormal>::Ptr livox2PCL(const livox_interfaces::msg::CustomMsg::SharedPtr msg, int filter_num, double min_range = 0.5, double max_range = 20.0);
