#include "utils.h"
pcl::PointCloud<pcl::PointXYZINormal>::Ptr Utils::livox2PCL(const livox_interfaces::msg::CustomMsg::SharedPtr msg, int filter_num, double min_range, double max_range)
{
